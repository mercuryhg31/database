...
ALTER TABLE item ADD CONSTRAINT item_pk PRIMARY KEY ( itm_number );

CREATE TABLE orders (
    id                    VARCHAR2(9) NOT NULL,
    odr_date                DATE NOT NULL,
    odr_time                  TIMESTAMP(0) NOT NULL,
...
ALTER TABLE price_history
    ADD CONSTRAINT price_history_pk PRIMARY KEY ( start_date,
                                                  start_time,
                                                  item_number );
ALTER TABLE price_history_items_fk FOREIGN KEY ( itm_number ) REFERENCES items (itms_number );
...
CREATE OR REPLACE TRIGGER fkntm_order BEFORE
    UPDATE OF customer_ctr_number ON orders
BEGIN
